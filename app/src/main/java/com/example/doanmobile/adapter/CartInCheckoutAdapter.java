...
public class CartInCheckoutAdapter extends BaseAdapter {
    private static ArrayList<ProductCart> productCartList;
    private Context context;
    private CartTotalListener cartTotalListener;


    public CartInCheckoutAdapter() {}

    public CartInCheckoutAdapter(ArrayList<ProductCart> productCartList, Context context) {
...
/*    public void setCartTotalListener(CartTotalListener listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            dataItem = new MyView();
            convertView = inflater.inflate(R.layout.item_cart_incheckout, null);
