...
public class CheckoutActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_recipientName = (EditText) findViewById(R.id.editText_recipientName);
        editText_shipToAddress = (EditText) findViewById(R.id.editText_shipToAddress);
        ...
        Double cartTotal = intent.getDoubleExtra("cartTotal", 0.0);
        ...
        btn_confirm.setOnClickListener(v -> {
            ...
            if(recipientName != "" && shipToAddress != "" && paymentMethod != ""){
    ...
    private void confirmCheckout(ArrayList<ProductCart> cartProducts, int invoiceId, String accountName, String accountUserName, String accountPhoneNumber,
                                 String recipientName, String shipToAddress, String paymentMethod, double cartTotal) {
